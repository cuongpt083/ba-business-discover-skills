# [Domain Name] Business Analyst Handbook

## Table of Contents
1. Domain Overview and Purpose
2. Domain Vocabulary and Concepts
...
- Value proposition
- Revenue or success drivers
- Key industry trends
- Key risks and constraints

## 2. Domain Vocabulary and Concepts
- Glossary table: Term | Definition | Used By | Notes
...
## 7. Information and Data
- Data inventory: Data Entity | Source | Owner | Used By | Issues
...
## 10. Root Cause Analysis
- Root cause summary: Problem | Root Cause | Constraint | Evidence

## 11. Opportunities and Solution Directions
- Opportunity backlog: Opportunity | Problem Solved | Impact | Effort | Risk

## 12. Current State Synthesis
- 1 to 2 page narrative summary
